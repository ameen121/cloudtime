    ...
    Route::group(
        ...
        function () {
            ...
            Route::group(['middleware' => ['account-setup', 'license-expire']], function () {
                ...
                Route::get('rota_delete/{id}', 'RotaController@delete')->name('rota.delete');
                Route::get('rotaEdit/{id}', 'RotaController@edit');
                Route::get('rota-search', 'RotaController@rotaSearch')->name('rota.search');
                ...
                // attendance
                Route::get('attendances/export/', ['uses' => 'ManageAttendanceController@export'])->name('attendances.export');
                Route::get('attendances/exportexcel/', ['uses' => 'ManageAttendanceController@export'])->name('attendances.excelexport');
...
// new route for employee filter using department
                Route::get('attendances/filter/department', ['uses' => 'ManageAttendanceController@employeeFilter'])->name('attendances.employeeFilter');
    ...
    Route::group(
        ...
        function () {
            ...
            Route::get('rotaEdit/{id}', 'RotaController@edit');
            Route::get('rota-search', 'RotaController@rotaSearch')->name('rota.search');
            Route::get('my-rota', 'RotaController@myRota')->name('myRota');
            ...
            // attendance
            Route::post('attendances/dateAttendanceCount', ['uses' => 'MemberAttendanceController@dateAttendanceCount'])->name('attendances.dateAttendanceCount');
            Route::get('attendances/byDateData', ['uses' => 'MemberAttendanceController@byDateData'])->name('attendances.byDateData');
            Route::get('attendances/attendance-by-date', ['uses' => 'MemberAttendanceController@attendanceByDate'])->name('attendances.attendanceByDate');
            ...
            Route::post('attendances/updateDetails/{id}', ['uses' => 'MemberAttendanceController@updateDetails'])->name('attendances.updateDetails');
               Route::get('attendanceData/{id}', ['uses' => 'MemberAttendanceController@editData'])->name('attendanceData.editData');
            Route::get('attendanceData1/{id}/{idd?}', ['uses' => 'MemberAttendanceController@editData1'])->name('attendanceData.editData1');
