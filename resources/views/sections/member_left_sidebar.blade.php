...
{{--            <a class="logo hidden-xs text-center" href="{{ route('member.dashboard') }}">--}}
    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar ">
        ...
        <ul class="nav" id="side-menu">
            ...
            @if(in_array('rota',$modules) && $user->cans('view_rota'))
                <li><a href="{{ route('member.rota.index') }}" class="waves-effect"><i class="icon-layers fa-fw"></i>Roster</a> </li>
            @endif
            @if(in_array('rota',$modules))
                <li><a href="{{ route('member.myRota') }}" class="waves-effect"><i class="icon-layers fa-fw"></i>My Roster</a> </li>
            @endif
