                                    ...
                                    <div class="col-xs-4 m-t-20">
                                        ...
                                        {{-- @if($attendanceSetup->count()==0) --}}
                                         @if(!is_null($currenntClockIn) && is_null(@$currenntClockIn->clock_out_time))
                                            ...
                                            <a href="javascript:showAttendanceModal({{@$currenntClockIn->id}});" class="btn btn-danger btn-sm" id=""> Clock Out1</a>
                                     {{-- @endif --}}
                                     @endif
                                         @if($attendanceSetup->count()==2)
                                        @if(!is_null($currenntClockIn) && is_null(@$currenntClockIn->first_close_break_time))
                                            <a href="javascript:showAttendanceModal1({{@$currenntClockIn->id}});" class="btn btn-success btn-sm" id=""> Clock In</a>
                                        @endif
                                        @if(!is_null($currenntClockIn) && is_null(@$currenntClockIn->first_open_break_time))
                                        dd
                                            <a href="javascript:showAttendanceModal({{@$currenntClockIn->id}});" class="btn btn-danger btn-sm" id=""> Clock Out</a>
                                        @endif
                                          @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->first_close_break_time) && is_null(@$currenntClockIn->clock_out_time))
                                          ddf
                                            <a href="javascript:showAttendanceModal({{@$currenntClockIn->id}});" class="btn btn-danger btn-sm" id=""> Clock Out</a>
                                        @endif
                                        @endif
                                    @if($attendanceSetup->count()==4)
                                        @if(!is_null($currenntClockIn) && is_null(@$currenntClockIn->first_close_break_time))
                                            <a href="javascript:showAttendanceModal1({{@$currenntClockIn->id}});" class="btn btn-success btn-sm" id=""> Clock In</a>
                                        @endif
 @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->lunch_break_start_time) &&  is_null(@$currenntClockIn->lunch_break_close_time))
                                            <a href="javascript:showAttendanceModal1({{@$currenntClockIn->id}});" class="btn btn-success btn-sm" id=""> Clock In</a>
                                        @endif
                                        @if(!is_null($currenntClockIn) && is_null(@$currenntClockIn->first_open_break_time))
                                            <a href="javascript:showAttendanceModal({{@$currenntClockIn->id}});" class="btn btn-danger btn-sm" id=""> Clock Out</a>
                                        @endif
                                         @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->first_close_break_time) && is_null(@$currenntClockIn->lunch_break_start_time))
                                            <a href="javascript:showAttendanceModal({{@$currenntClockIn->id}});" class="btn btn-danger btn-sm" id=""> Clock Out</a>
                                        @endif
                                          @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->lunch_break_close_time) && is_null(@$currenntClockIn->clock_out_time))
                                            <a href="javascript:showAttendanceModal({{@$currenntClockIn->id}});" class="btn btn-danger btn-sm" id=""> Clock Out</a>
                                        @endif
                                        @endif
                                        @if($attendanceSetup->count()==6)
                                        @if(!is_null($currenntClockIn) && is_null(@$currenntClockIn->first_close_break_time))
                                            <a href="javascript:showAttendanceModal1({{@$currenntClockIn->id}});" class="btn btn-success btn-sm" id=""> Clock In</a>
                                        @endif
 @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->lunch_break_start_time) &&  is_null(@$currenntClockIn->lunch_break_close_time))
                                            <a href="javascript:showAttendanceModal1({{@$currenntClockIn->id}});" class="btn btn-success btn-sm" id=""> Clock In</a>
                                        @endif
                                        @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->third_break_in) &&  is_null(@$currenntClockIn->third_break_out))
                                            <a href="javascript:showAttendanceModal1({{@$currenntClockIn->id}});" class="btn btn-success btn-sm" id=""> Clock In</a>
                                        @endif
                                        @if(!is_null($currenntClockIn) && is_null(@$currenntClockIn->first_open_break_time))
                                            <a href="javascript:showAttendanceModal({{@$currenntClockIn->id}});" class="btn btn-danger btn-sm" id=""> Clock Out</a>
                                        @endif
                                         @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->first_close_break_time) && is_null(@$currenntClockIn->lunch_break_start_time))
                                            <a href="javascript:showAttendanceModal({{@$currenntClockIn->id}});" class="btn btn-danger btn-sm" id=""> Clock Out</a>
                                        @endif
                                          @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->lunch_break_close_time) && is_null(@$currenntClockIn->third_break_in))
                                            <a href="javascript:showAttendanceModal({{@$currenntClockIn->id}});" class="btn btn-danger btn-sm" id=""> Clock Out</a>
                                        @endif
                                          @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->third_break_out) && is_null(@$currenntClockIn->clock_out_time))
                                            <a href="javascript:showAttendanceModal({{@$currenntClockIn->id}});" class="btn btn-danger btn-sm" id=""> Clock Out</a>
                                        @endif
                                        @endif
                                            @if($attendanceSetup->count()==8)
                                        @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->first_open_break_time) && is_null(@$currenntClockIn->first_close_break_time))
                                            <a href="javascript:showAttendanceModal1({{@$currenntClockIn->id}});" class="btn btn-success btn-sm" id=""> Clock In</a>
                                        @endif
 @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->lunch_break_start_time) &&  is_null(@$currenntClockIn->lunch_break_close_time))
                                            <a href="javascript:showAttendanceModal1({{@$currenntClockIn->id}});" class="btn btn-success btn-sm" id=""> Clock In</a>
                                        ...
                                        @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->third_break_in) &&  is_null(@$currenntClockIn->third_break_out))
                                            <a href="javascript:showAttendanceModal1({{@$currenntClockIn->id}});" class="btn btn-success btn-sm" id=""> Clock In</a>
                                        @endif
                                         @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->for_break_in) &&  is_null(@$currenntClockIn->for_break_out))
                                            <a href="javascript:showAttendanceModal1({{@$currenntClockIn->id}});" class="btn btn-success btn-sm" id=""> Clock In</a>
                                        @endif
                                        @if(!is_null($currenntClockIn) && is_null(@$currenntClockIn->first_open_break_time))
                                        ...
                                        @endif
                                          @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->lunch_break_close_time) && is_null(@$currenntClockIn->third_break_in))
                                            ...
                                            <a href="javascript:showAttendanceModal({{@$currenntClockIn->id}});" class="btn btn-danger btn-sm" id=""> Clock Out</a>
                                        @endif
                                         @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->third_break_out) && is_null(@$currenntClockIn->for_break_in))
                                         
                                            <a href="javascript:showAttendanceModal({{@$currenntClockIn->id}});" class="btn btn-danger btn-sm" id=""> Clock Out</a>
                                        @endif
                                          @if(!is_null($currenntClockIn) && !is_null(@$currenntClockIn->for_break_out) && is_null(@$currenntClockIn->clock_out_time))
...
<script>
    ...
    function showAttendanceModal1(id) {
        var url = '{{ route('member.attendanceData.editData1',':id') }}';
        url = url.replace(':id', id);
