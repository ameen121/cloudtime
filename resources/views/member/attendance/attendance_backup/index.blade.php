...
@section('content')
            ...
            <div class="white-box">
                <nav>
                    <ul>
                       ...
                       <li><a href="{{ route('member.attendances.attendanceByDate') }}"><span>@lang('modules.attendance.attendanceByDate')</span></a>                     </li>
    ...
    <div class="row">
        ...
        <?php
        $attendanceSetup=\App\AttedanceSetup::query()->orderBy('created_at','DESC')->where('company_id',\Illuminate\Support\Facades\Auth::user()->company_id)->get();
...
//                                    swal("Deleted!", response.message, "success");
        ...
        {{--    var url = '{{ route('member.employees.export', [':status' ,':employee', ':role']) }}';--}}
