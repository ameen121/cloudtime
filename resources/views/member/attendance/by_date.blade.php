    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 bg-title-right">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="{{ route('member.attendances.index') }}">{{ __($pageTitle) }}</a></li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
            ...
            <div class="white-box">
                <nav>
                    <ul>
                        ...
                        <li class="tab-current"><a href="{{ route('member.attendances.attendanceByDate') }}"><span>@lang('modules.attendance.attendanceByDate')</span></a>
                        </li>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="attendance_date" id="attendance_date" value="{{ \Carbon\Carbon::now()->timezone($global->timezone)->format($global->date_format) }}">
                        </div>
                    </div>
                </div>
                <div class="row dashboard-stats">
                    <div class="col-md-12 m-b-30">
                        <div class="white-box">
                            ...
                            <div class="col-sm-4 b-l text-center">
                                <h4><span class="text-danger" id="employeesAbsent">0</span> <span class="font-12 text-muted m-l-5">  @lang('modules.attendance.absent')</span></h4>
                            </div>
    ...
    <script>
        ...
        function showTable(){
            table = $('#attendance-table').dataTable({
                ...
                searching: false,
                ajax: {
                    url: "{!! route('member.attendances.byDateData') !!}",
                    data: function (d) {
        ...
        function getAttendanceCount(date){
            $.easyAjax({
                url: '{{route('member.attendances.dateAttendanceCount')}}',
                type: "POST",
                data: {
                    date: date,
                    _token: '{{ csrf_token() }}'
