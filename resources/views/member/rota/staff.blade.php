...
@section('content')
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('member.rota.search') }}">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title">Roster <b>({{ $startDate1 }} To {{ $endDate1 }})</b>   |<b>  Title : {{$staffsrequest!=null? 'Staff('.$staffsrequest->name.')':' All Staff'}}</h3>
                {{--                <div class="float-right">--}}
 ...
 $color="b1bc3c";
                                        ...
                                        <td class="text-center text-uppercase profile-pic" @if($checkDate) style="background-color: #{{ $color }}" @endif>
                                                                ...
                                                                class="fa fa-edit"></i></a>  <a href="{{ route('member.rota.delete',$checkDate->id) }}"
...
@push('footer-script')
    <script>
        function showAdd() {
            var url = "{{ route('member.rota.create') }}";
            $.ajaxModal('#edit-column-form', url);
        }
        function showAdd1(id) {
            var url = "{{url('member/rotaEdit')}}/"+id;
            console.log(url);
