                        ...
                        <div id="vhome3" class="tab-pane active">
                            ...
                            <div class="row">
                                <div class="form-body ">
                                 ...
                                 if($attendanceSetup->count() > 0){
                                    ...
                                    if($first_start_value->count()>0){
                                        $status_first= $first_start_value;
                                        $first_start_value=$first_start_value->first()->name;
                                        $status_first=$status_first->first()->status;
                                    ...
                                    if($second_start_value->count()>0){
                                        $status_second= $second_start_value;
                                        $second_start_value=$second_start_value->first()->name;
                                        $status_second=$status_second->first()->status;
                                    }else{
                                        $second_start_value="";
                                    }
                                    ...
                                    if($third_start_value->count()>0){
                                        $status_third= $third_start_value;
                                        $third_start_value=$third_start_value->first()->name;
                                        $status_third=$status_third->first()->status;
                                    }else{
                                        $third_start_value="";
                                    }
                                    ...
                                    if($fourth_start_value->count()>0){
                                        $status_four=$fourth_start_value;
                                        $fourth_start_value=$fourth_start_value->first()->name;
                                        $status_four= $status_four->first()->status;
                                    }else{
                                        $fourth_start_value="";
                                    }
                                    ...
                                    if($fifth_start_value->count()>0){
                                        $status_five=  $fifth_start_value; 
                                        $fifth_start_value=$fifth_start_value->first()->name;
                                         $status_five= $status_five->first()->status;
                                    }else{
                                        $fifth_start_value="";
                                    }
                                    ...
                                    if($sixth_start_value->count()>0){
                                        $status_six=  $sixth_start_value; 
                                        $sixth_start_value=$sixth_start_value->first()->name;
                                        $status_six= $status_six->first()->status;
                                    ...
                                    if($seventh_start_value->count()>0){
                                        $status_seven=$seventh_start_value;
                                        $seventh_start_value=$seventh_start_value->first()->name;
                                        $status_seven= $status_seven->first()->status;
                                    }else{
                                        $seventh_start_value="";
                                    }
                                    ...
                                    if($eight_start_value->count()>0){
                                        $status_eight= $eight_start_value;
                                        $eight_start_value=$eight_start_value->first()->name;
                                        $status_eight= $status_eight->first()->status;
                                    ...
                                    if($nineth_start_value->count()>0){
                                        $status_nine= $nineth_start_value;
                                        $nineth_start_value=$nineth_start_value->first()->name;
                                        $status_nine= $status_nine->first()->status;
                                    }else{
                                        $nineth_start_value="";
                                    }
                                ...
                                <div class="col-md-12 nodiv" id="divOne">
                                        ...
                                        <select id="dropdown1" class="form-control" id="exampleFormControlSelect1"
                                        name="type[]"   <?php echo (($first_start_value!="") && ($first_end_value!="") ) ? '':'disabled'  ?>> 
                                        <option value="1" <?php echo ($status_first==1)?'selected':'' ?> >Paid
                                        </option>
                                        <option value="0" <?php echo ($status_first==0)?'selected':'' ?> >
                                        UnPaid
                                        </option>
                                        </select>
                                        </div>
                                    ...
                                    <div class="col-md-12 nodiv" id="divTwo" style="margin-top:2px">
                                        ...
                                        <select id="dropdown2" class="form-control" id="exampleFormControlSelect1"
                                        name="type[]"   <?php echo (($second_start_value!="") && ($second_end_value!="") ) ? '':'disabled'  ?>>
                                        <option value="1" <?php echo ($status_second==1)?'selected':''?> >Paid
                                        </option>
                                        <option value="0" <?php echo ($status_second==0)?'selected':''?>>
                                        UnPaid
                                        </option>
                                        </select>
                                        </div>
                                    ...
                                    <div class="col-md-12 nodiv" id="divThree" style="margin-top:2px">
                                        ...
                                        <select id="dropdown3" class="form-control" id="exampleFormControlSelect1"
                                        name="type[]"   <?php echo (($third_start_value!="") && ($third_end_value!="") ) ? '':'disabled'  ?>>
                                        <option value="1" <?php echo ($status_third==1)?'selected':'' ?>>Paid
                                        </option>
                                        <option value="0" <?php echo ($status_third==0)?'selected':'' ?>>
                                        UnPaid
                                        </option>
                                        </select>
                                        </div>
                                    ...
                                    <div class="col-md-12 nodiv" id="divFour" style="margin-top:2px">
                                        ...
                                        <select  id="dropdown4" class="form-control" id="exampleFormControlSelect1"
                                        name="type[]"    <?php echo (($fourth_start_value!="") && ($fourth_end_value!="") ) ? '':'disabled'  ?>>
                                        <option value="1"  <?php echo ($status_four==1)?'selected':'' ?>>Paid
                                        </option>
                                        <option value="0" <?php echo ($status_four==0)?'selected':'' ?>>
                                        UnPaid
                                        </option>
                                        </select>
                                        </div>
                                    ...
                                    <div class="col-md-12 nodiv" id="divFive" style="margin-top:2px">
                                        ...
                                        <select id="dropdown5" class="form-control" id="exampleFormControlSelect1"
                                        name="type[]"  <?php echo (($fifth_start_value!="") && ($fifth_end_value!="") ) ? '':'disabled'  ?>>
                                        <option value="1"  <?php echo ($status_five==1)?'selected':'' ?>>Paid
                                        </option>
                                        <option value="0"  <?php echo ($status_five==0)?'selected':'' ?>>
                                        UnPaid
                                        </option>
                                        </select>
                                        </div>
                                    ...
                                    <div class="col-md-12 nodiv" id="divSix" style="margin-top:2px">
                                        ...
                                        <select id="dropdown6"  <?php echo (($sixth_start_value!="") && ($sixth_end_value!="") ) ? '':'disabled'  ?> class="form-control" id="exampleFormControlSelect1"
                                        name="type[]">
                                        <option value="1" <?php echo ($status_six==1)?'selected':'' ?>>Paid
                                        </option>
                                        <option value="0" <?php echo ($status_six==0)?'selected':'' ?>>
                                        UnPaid
                                        </option>
                                        </select>
                                        </div>
                                    ...
                                    <div class="col-md-12 nodiv" id="divSeven" style="margin-top:2px">
                                        ...
                                        <select   id="dropdown7" <?php echo (($seventh_start_value!="") && ($seventh_end_value!="") ) ? '':'disabled'  ?> class="form-control" id="exampleFormControlSelect1"
                                        name="type[]">
                                        <option value="1"  <?php echo ($status_seven==1)?'selected':'' ?>>Paid
                                        </option>
                                        <option value="0"  <?php echo ($status_seven==0)?'selected':'' ?>>
                                        UnPaid
                                        </option>
                                        </select>
                                        </div>
                                       ...
                                       >
                                        ...
                                        <select   id="dropdown8" <?php echo (($eight_start_value!="") && ($eight_end_value!="") ) ? '':'disabled'  ?>  class="form-control" id="exampleFormControlSelect1"
                                        name="type[]">
                                        <option value="1" <?php echo ($status_eight==1)?'selected':'' ?>>Paid 
                                        </option>
                                        <option value="0"  <?php echo ($status_eight==0)?'selected':'' ?>>
                                        UnPaid 
                                        </option>
                                        </select>
                                        </div>
                                    ...
                                    <div class="col-md-12 nodiv" id="divNine" style="margin-top:2px">
                                        ...
                                        <select  id="dropdown9" class="form-control" id="exampleFormControlSelect1"
                                        name="type[]" <?php echo (($nineth_start_value!="") && ($nineth_start_value!="") ) ? '':'disabled'  ?>>
                                        <option value="1" <?php echo ($status_nine==1)?'selected':'' ?>>Paid
                                        </option>
                                        <option value="0" <?php echo ($status_nine==0)?'selected':'' ?>>
                                        UnPaid
                                        </option>
                                        </select>
                                        </div>
...
$("#checkbox_all").change(function() {
    ...
    $("#checkbox_five").change(function() {
            if($(this).prop('checked')) {
                $("#divFive :input[type='text']").attr("disabled", false);
                $("#divFive :input[type='hidden']").attr("disabled", false);
                $("#dropdown5").attr("disabled", false);
            } else {
                $("#divFive :input[type='text']").attr("disabled", true);
                $("#divFive :input[type='hidden']").attr("disabled", true);
                $("#dropdown5").attr("disabled", true);
            }
    });
    $("#checkbox_six").change(function() {
            if($(this).prop('checked')) {
                $("#divSix :input[type='text']").attr("disabled", false);
                $("#divSix :input[type='hidden']").attr("disabled", false);
                $("#dropdown6").attr("disabled", false);
            } else {
                $("#divSix :input[type='text']").attr("disabled", true);
                $("#divSix :input[type='hidden']").attr("disabled", true);
                $("#dropdown6").attr("disabled", true);
            }
    });
    $("#checkbox_seven").change(function() {
            if($(this).prop('checked')) {
                $("#divSeven :input[type='text']").attr("disabled", false);
                $("#divSeven :input[type='hidden']").attr("disabled", false);
                $("#dropdown7").attr("disabled", false);
            } else {
                $("#divSeven :input[type='text']").attr("disabled", true);
                $("#divSeven :input[type='hidden']").attr("disabled", true);
                $("#dropdown7").attr("disabled", true);
            }
    });
    $("#checkbox_eight").change(function() {
            ...
            if($(this).prop('checked')) {
                $("#divEight :input[type='text']").attr("disabled", false);
                $("#divEight :input[type='hidden']").attr("disabled", false);
                $("#dropdown8").attr("disabled", false);
            } else {
                $("#divEight :input[type='text']").attr("disabled", true);
                $("#divEight :input[type='hidden']").attr("disabled", true);
                $("#dropdown8").attr("disabled", true);
            }
    });
    $("#checkbox_nine").change(function() {
            if($(this).prop('checked')) {
                $("#divNine :input[type='text']").attr("disabled", false);
                $("#divNine :input[type='hidden']").attr("disabled", false);
                $("#dropdown9").attr("disabled", false);
            } else {
                $("#divNine :input[type='text']").attr("disabled", true);
                $("#divNine :input[type='hidden']").attr("disabled", true);
                $("#dropdown9").attr("disabled", true);
            }
    });
});   
