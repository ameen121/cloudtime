                                ...
                                <div class="form-body ">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            @if(!empty($array[0]))
                                                <div class="col-md-12" id="input_text1_wrapper">

                                                    <div class="col-md-3">
                                                        <select class="form-control" id="exampleFormControlSelect1"
                                                                name="type[]">
                                                            <option value="1" @if(@$array1[0]==1) selected @endif>Paid
                                                            </option>
                                                            <option value="0" @if(@$array1[0]==0) selected @endif>
                                                                UnPaid
                                                            </option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type='button' value='Remove'
                                                               onclick=remove_field('input_text1');>
                                                    </div>
                                                </div>
                                            @endif
                                            @if(!empty($array[2]))
