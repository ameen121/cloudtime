                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="machine_ip" id="machine_ip" class="form-control" value="{{ $group->machine_ip }}">
                                </div>
                                <div class="form-group">
                                    <label>Machine PORT</label>
                                    <input type="text" name="machine_port" id="machine_port" class="form-control" value="{{ $group->machine_port }}">
                                </div>
