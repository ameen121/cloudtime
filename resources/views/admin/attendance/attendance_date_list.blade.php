                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @if($row->attendance->count() > 0)
                                            @if($row->attendance->first()->late == "yes") <span class="label label-success"><i class="fa fa-check"></i> @lang('app.yes')</span>
                                            @else
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        @if($row->attendance->count() > 0)
                                            @if($row->attendance->first()->half_day == "yes") <span class="label label-success"><i class="fa fa-check"></i> @lang('app.yes')</span>
                                            @else
                                                <span class="label label-danger"><i class="fa fa-times"></i> @lang('app.no')</span>
                                            @endif
                                        @else
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                         <?php $company=\App\Company::where('id',\Illuminate\Support\Facades\Auth::user()->company_id)->first(); ?>
                                        @forelse($row->attendance as $index => $attendance)
                                            <tr>
                                                ...
                                                <td width="30%" class="al-center bt-border">
                                                    @if(!is_null($attendance->clock_out_time)) {{ $attendance->clock_out_time->timezone($company->timezone)->format($global->time_format) }} @else - @endif
                                                </td>
