                        ...
                        <div class="row">
                                ...
                                <div class="form-body ">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group bootstrap-timepicker timepicker">
                                                <label>{{$dataAttendanceArray[1]}} </label>
                                                <input type="text" name="first_open_break_time"
                                                       class="form-control a-timepicker"   autocomplete="off"   id="clock-in-time"
                                                       @if(!is_null($row->first_open_break_time)) value="{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->first_open_break_time)->timezone($global->timezone)->format($global->time_format) }}" @endif>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="input-group bootstrap-timepicker timepicker">
                                                <label>{{$dataAttendanceArray[2]}} </label>
                                                <input type="text" name="first_close_break_time"
                                                       class="form-control a-timepicker"   autocomplete="off"   id="clock-in-time"
                                                       @if(!is_null($row->first_close_break_time)) value="{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->first_close_break_time)->timezone($global->timezone)->format($global->time_format) }}" @endif>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="input-group bootstrap-timepicker timepicker">
                                                <label>{{$dataAttendanceArray[3]}} </label>
                                                <input type="text" name="lunch_break_start_time"
                                                       class="form-control a-timepicker"   autocomplete="off"   id="clock-in-time"
                                                       @if(!is_null($row->lunch_break_start_time)) value="{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->lunch_break_start_time)->timezone($global->timezone)->format($global->time_format) }}" @endif>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="input-group bootstrap-timepicker timepicker">
                                                <label>{{$dataAttendanceArray[4]}} </label>
                                                <input type="text" name="lunch_break_close_time"
                                                       class="form-control a-timepicker"   autocomplete="off"   id="clock-in-time"
                                                       @if(!is_null($row->lunch_break_close_time)) value="{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->lunch_break_close_time)->timezone($global->timezone)->format($global->time_format) }}" @endif>
                                            </div>
                                        </div>
