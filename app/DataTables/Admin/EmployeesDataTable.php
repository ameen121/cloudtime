...
class EmployeesDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->addColumn('department_name', function ($row) use ($roles) {
                @$departmentName=$row->employeeDetail->department->team_name;
                return @$departmentName;
//dd();
               // return $row->employeeDetail->department->team_name;
            })
            ->addIndexColumn()
    ...
    protected function getColumns()
    {
        return [
            ...
            __('branch') => ['data' => 'department_name', 'name' => 'branch'],
