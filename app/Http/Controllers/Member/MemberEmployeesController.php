...
class MemberEmployeesController extends MemberBaseController
{
    ...
    public function index()
    {
        ...
        $this->employees = User::allEmployees()->where('employeeDetail.department_id',$EmployeeData->department_id);
    ...
    public function data(Request $request)
    {
        ...
        $users = User::with('employeeDetail')->leftJoin('role_user', 'role_user.user_id', '=', 'users.id')
        ...
        $users = $users->get()->where('employeeDetail.department_id',$EmployeeData->department_id);
        ;
