...
if (!function_exists('calculatedTime')) {

    function calculatedTime($calPaidTimeReasons="",$attId=""){
      
       $attendance= $calPaidTimeReasons->where('attendance_id',$attId);
       if($attendance->count()>0){
        ...
        $time2=[];
            ...
            return  CalculateTimeHours($time1);
...
if (!function_exists('unPaidHours')) {

    function unPaidHours($calPaidTimeReasons="",$attId=""){
       ...
       if($attendance->count()>0){
        ...
        $calUnPaid=[];
            ...
            foreach($attendance as $time){
                ...
                if(($time->first_break_start!=null && $time->first_break_end!=null) && ($time->status_1===0  )){
                        $start_time=date('H:i',strtotime($time->first_break_start));
                        $end_time=date('H:i',strtotime($time->first_break_end));
                        $start = strtotime($start_time);
                        $end = strtotime($end_time);
                        $cal_time = $end - $start;
                        array_push($calUnPaid, date("H:i", $cal_time));
                    }
                    if(($time->second_break_start!=null && $time->second_break_end!=null) && ($time->status_2===0 )){
                        $start_time=date('H:i',strtotime($time->second_break_start));
                        $end_time=date('H:i',strtotime($time->second_break_end));
                        $start = strtotime($start_time);
                        $end = strtotime($end_time);
                    ...
                    if(($time->third_break_start!=null && $time->third_break_end!=null) && ($time->status_3===0 )){
                            $start_time=date('H:i',strtotime($time->third_break_start));
                            $end_time=date('H:i',strtotime($time->third_break_end));
                            $start = strtotime($start_time);
                            $end = strtotime($end_time);
                    ...
                    if(($time->four_break_start!=null && $time->four_break_end!=null) && ($time->status_4===0 ) ){
                        $start_time=date('H:i',strtotime($time->four_break_start));
                        $end_time=date('H:i',strtotime($time->four_break_end));
                        $start = strtotime($start_time);
                        $end = strtotime($end_time);
                    ...
                    if(($time->five_break_start!=null && $time->five_break_end!=null) && ($time->status_5===0)){
                        $start_time=date('H:i',strtotime($time->five_break_start));
                        $end_time=date('H:i',strtotime($time->five_break_end));
                        $start = strtotime($start_time);
                        $end = strtotime($end_time);
                    ...
                    if(($time->six_break_start!=null && $time->six_break_end!=null) && ($time->status_6===0 )){
                        $start_time=date('H:i',strtotime($time->six_break_start));
                        $end_time=date('H:i',strtotime($time->six_break_end));
                        $start = strtotime($start_time);
                        $end = strtotime($end_time);
                    ...
                    if(($time->seven_break_start!=null && $time->seven_break_end!=null) && ($time->status_7===0)){
                        $start_time=date('H:i',strtotime($time->seven_break_start));
                        $end_time=date('H:i',strtotime($time->seven_break_end));
                        $start = strtotime($start_time);
                        $end = strtotime($end_time);
                    ...
                    if(($time->eight_break_start!=null && $time->eight_break_end!=null) && ($time->status_8===0 )){
                        $start_time=date('H:i',strtotime($time->eight_break_start));
                        $end_time=date('H:i',strtotime($time->eight_break_end));
                        $start = strtotime($start_time);
                        $end = strtotime($end_time);
                    ...
                    if(($time->nine_break_start!=null && $time->nine_break_end!=null) && ($time->status_9===0 )  ){
            ...
            return  CalculateTimeHours($calUnPaid);
...
if (!function_exists('calculatedTime1')) {
    function calculatedTime1($calPaidTimeReasons="",$attId=""){
       $attendance= $calPaidTimeReasons->where('attendance_id',$attId);
       if($attendance->count()>0){
        $time2=[];
            foreach($attendance as $time){
            ...
            return  CalculateTimeHours($time2);                                                                       
        }
    }
}
...
function CalculateTimeHours($aElapsedTimes) {
    $totalHours = 0;
    $totalMinutes = 0;
